...
public class SpeedCommand extends BaseCommand {
    ...
    public boolean execute(Player player, String[] args) {
        ...
        try {
            ...
            if (speed < 10 || speed > 1000) {
                player.sendMessage(ChatColor.RED + "Speed must be between 10 and 1000 blocks per tick!");
    ...
    public String getDescription() {
        return "Set custom restore speed for an area (10-1000 blocks/tick) or use 'dynamic'";
    }
    ...
    public List<String> getTabCompletions(Player player, String[] args) {
        if (args.length == 1) {
            ...
            return Arrays.asList("dynamic", "50", "100", "200", "400");
        }
        return List.of();
    }
}
